...
setwd("~/Documenti/data-viz/Temperature Giugno Italia")

wf_set_key(user = "...",  
           key  = "...") 


output_dir = "~/Documenti/data-viz/Temperature Giugno Italia/Dati"
...
for (start in start_years) {
  ...
  req = list(
    ...
    "area"               = c(47, 6, 36, 19),
    "format"             = "netcdf",
    "target"             = paste0("ERA5L_T2m_Mean_Italy_June_", start, "_", end, ".nc")
  )
